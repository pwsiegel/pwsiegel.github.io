...
* Every continuous map $f \colon X \to Y$ induces a group homomorphism $f_* \colon \pi_1(X) \to \pi_1(Y)$.</li>
* If $f_1, f_2 \colon X \to Y$ are homotopic continuous maps then $(f_1)_* = (f_2)_* \colon \pi_1(X) \to \pi_1(Y)$.</li>
* $\pi_1(S^1)$ is not the trivial group.</li>
